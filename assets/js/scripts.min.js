function initSearch() {
    getParameterByName("q") && (q = decodeURIComponent(getParameterByName("q")), $searchInput.val(q), execSearch(q)), $('input[type="submit"][value="بگرد"]').on("submit", $searchForm, function (a) {
...
var navigation = responsiveNav("#site-nav", {
    animate: !0,
    transition: 200,
    label: "<i class='fa fa-bars'></i> منو کاربری",
    insert: "before",
    customToggle: "",
    openPos: "relative",
    jsClass: "js",
